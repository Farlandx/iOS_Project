//
//  BreathSoundTableViewController.m
//  呼吸照護
//
...
@interface BreathSoundTableViewController ()

@end

@implementation BreathSoundTableViewController {
    NSArray *rowData;
}
...
- (void)viewDidLoad
{
    ...
    rowData = [NSArray arrayWithObjects:@"Clear", @"Coarse", @"Crackle", @"Wheeze", @"Rhonchus", @"Decrease", @"Stridor", nil];
}
...
{
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"Breath Sound Cell" forIndexPath:indexPath];
