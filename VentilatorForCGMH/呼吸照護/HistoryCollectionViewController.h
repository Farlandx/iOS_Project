...
#define ARRAY_TITLE @[@"床號", @"病歷號", @"呼吸器", @"Ventilation Mode", @"TidalVolume Set", @"TidalVolume Measured", @"Ventilation Rate Set/Total/Hertz", @"Flow/NO/NO₂", @"Insp. T / I:E", @"MV Set/MinVol%/Total", @"Peak/Plateau", @"Mean/PEEP", @"P.S/P.C/amplitude", @"Temp/Tube compensation", @"FiO₂ Set/Measured", @"Resistance/Compliance", @"Base Flow/Flow sens", @"Volume/Flow Assist", @"Edi peak/min", @"NAVA Level/Edi trigger", @"L. MV/ H. Pr. Alarm/ Relief Pr.", @"時間", @"PH", @"PaCO2 / PetCO2", @"PaO₂ / Site", @"HCO₃ / BE", @"SaO₂ / SpO₂", @"PA-aO₂ / Shunt", @"P/F ratio", @"RR/OI", @"TV/MV", @"Max Pi/Pe", @"MVV/VC", @"RSBI", @"ET Size/mark", @"Cuff pressure/leak test", @"Breath Sound", @"治療師"]
